...
<style>
  * {
  ...
  body {
    ...
    counter-reset: bodyPage 0; /* Reset counter nomor halaman di body */
  }
  ...
  /* ---------- HEADER & FOOTER REPEATING CONTAINER ---------- */
  .page-container {
    width: 100%;
  ...
  /* CONTAINER FOOTER NOMOR HALAMAN */
  tfoot {
  ...
  /* PENOMORAN HALAMAN: WARNA, UKURAN, DAN POSISI SAMA DENGAN GAMBAR */
  .page-number::before {
