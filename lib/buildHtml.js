...
<style>
  * {
  ...
  /* ---------- TAMPILAN PRINT / CETAK PDF ---------- */
@page {
  size: A4;
  margin: 0; 
}

/* 2. Kunci ukuran A4 secara mutlak di layar */
.page {
  width: 210mm;
  height: 297mm;
  position: relative; /* Kunci acuan position: absolute */
  box-sizing: border-box;
  overflow: hidden;   /* Cegah elemen meledak keluar A4 */
}

/* 3. Hapus atau Samakan isi @media print dengan CSS utama */
@media print {
  ...
  /* ---------- COVER PAGE ---------- */
.page {
    position: relative; /* Kunci utama acuan posisi absolute */
  }
  ...
  .cover-title-block { 
    text-align: right; 
    margin-top: 250pt; /* Menyesuaikan posisi turunnya teks */
    line-height: 1.3;
  }
  ...
  .cover-footer {
    position: absolute;
    bottom: 0.8in; /* Posisi terkunci dari batas bawah A4 */
    right: 1in;   /* Posisi terkunci sejajar dengan margin kanan */
    text-align: right;
  }

  /* Kunci penyesuaian: Jangan timpa footer di media print agar posisinya konsisten */
  @media print {
    .cover-footer {
      bottom: 0.8in;
      right: 1in;
