...
<style>
  * {
  ...
  /* ---------- SETUP MARGIN CETAK GLOBAL ---------- */
  @page {
    size: A4 portrait;
    margin: 1in; /* Memberikan margin konsisten di setiap halaman otomatis */
    @bottom-right {
  ...
  .page {
    ...
    position: relative;
    box-sizing: border-box;
    padding: 0; /* Padding dipindah ke margin @page agar tidak mentok saat break */
    background: #ffffff;
  }
  ...
  .page-content > h2.section:first-of-type {
    margin-top: 0;
  }
