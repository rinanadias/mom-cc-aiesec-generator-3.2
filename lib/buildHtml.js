...
<style>
  * {
  ...
  body {
    ...
    counter-reset: bodyPage 0; /* Reset counter halaman untuk bagian body */
  }

  /* ---------- ATURAN HALAMAN PRINT & NOMOR HALAMAN DINAMIS ---------- */
  @page {
    size: A4 portrait;
    margin: 0 0 1.2in 0; /* Menyiapkan margin bawah untuk tempat nomor halaman */
  }
  ...
  /* Halaman Cover khusus tanpa nomor */
  .page-cover {
    page: cover-page;
  }

  /* Halaman 2+ (Body) menggunakan counter penomoran halaman otomatis */
  .page-body {
  ...
  @media screen {
    ...
    /* Penomoran halaman dinamis khusus tampilan Layar Browser (CSS Counter) */
    .page-body::after {
  ...
  /* KUNCI KONSISTENSI KELONGGARAN HEADER DI SEMUA HALAMAN */
  .page-container {
    width: 100%;
