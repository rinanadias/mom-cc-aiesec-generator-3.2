...
<style>
  * {
  ...
  /* Sembunyikan nomor halaman di Cover */
  @page :first {
    @bottom-right {
      content: "";
    }
  ...
  /* Penomoran otomatis berurutan (1, 2, 3...) di pojok kanan bawah mulai halaman 2 */
  @page {
    @bottom-right {
  ...
  @media screen {
    ...
    /* Penomoran visual saat preview di layar HP/Desktop */
    .page-body::after {
      content: "1";
      position: absolute;
      bottom: 0.5in;
