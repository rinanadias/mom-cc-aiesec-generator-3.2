...
<style>
  * {
  ...
  /* Kusus untuk Halaman 2+, padding atas disesuaikan agar jarak simetris */
  .page-body {
  ...
  .page-header-cell {
    /* Jarak dari batas atas kertas ke header & dari header ke konten diset seimbang (0.25in) */
    padding-top: 0.1in;
  ...
  /* ---------- COVER PAGE (SAMA PERSIS DENGAN KODE ASLI) ---------- */
  .cover-logo {
    height: 40pt;
    width: auto;
    position: absolute;
