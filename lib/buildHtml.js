...
<style>
  * {
  ...
  /* ---------- COVER PAGE ---------- */
  .cover-logo {
    height: 63pt;       /* Ukuran logo AIESEC */
    width: auto;
    position: absolute;
    top: 0.8in;         /* Jarak dari batas atas kertas */
    left: 0.8in;        /* Jarak dari batas kiri kertas */
  }

  .cover-title-block { 
    text-align: right; 
    margin-top: 220pt;  /* Atur jarak blok judul dari atas */
  }
