...
<style>
  * {
  ...
  /* Halaman 2+ menggunakan padding yang konsisten */
  .page-body {
  ...
  @media print {
    ...
    .page-footer-number {
      display: none; /* Menyembunyikan elemen HTML footer saat di-print karena memakai @page */
    }
  }

  /* Footer penomoran untuk tampilan layar (HTML preview) */
  .page-footer-number {
    position: absolute;
    bottom: 0.8in;
    right: 1in;
...
<body>
  ...
  <div class="page page-body">
    ...
    <div class="page-footer-number">2</div>
  </div>
