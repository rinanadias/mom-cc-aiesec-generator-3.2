...
<style>
  * {
  ...
  .cover-footer {
    position: absolute;
    bottom: 2.3in;        /* Jarak footer dari batas bawah A4 */
    right: 0.6in;         /* Sejajar dengan margin kanan */
    text-align: right;
  }
  ...
  .kv-table.countdown-table tbody {
  ...
  .countdown-date { font-weight: 400; font-size: 10.5pt; margin-bottom: 1pt; margin-top: -31pt; margin-left: 12pt; }

  /* Khusus judul section 3 */
h2.section.countdown-title {
  transform: translateY(-52px);
}

/* Khusus elemen results-intro */
.results-intro {
  font-size: 10.5pt;
  margin-bottom: 6pt;
  margin-left: 14pt;
  margin-top: -29px; /* Tambahkan baris ini jika perlu */
}

  table.agenda { width: 96%; margin-bottom: 12pt; margin-left: 14pt; margin-top: -27pt; }
  ...
  .results-intro { font-size: 10.5pt; margin-bottom: 6pt; margin-left: 14pt; }
