...
<style>
  * {
  ...
  /* Halaman Pertama (Cover) tanpa margin agar posisi absolut cover tidak bergeser */
  @page :first {
    margin: 0;
    @bottom-right {
      content: none;
...
<body>
  ...
  <div class="content-wrapper">
    ...
    <h2 class="section" style="margin-top: 0;">1. Attendance List</h2>
    <table class="grid">
