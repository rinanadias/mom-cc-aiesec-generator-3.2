...
<style>
  * {
  ...
  /* ---------- KODE ASLI LAYOUT .PAGE SAMA PERSIS ---------- */
  .page {
    width: 210mm;
    min-height: 297mm;
    position: relative;
  ...
  /* ---------- ATURAN HALAMAN PRINT UTK OTOMATIS HEADER & MARGIN ATAS HALAMAN 2+ ---------- */
  @page {
    size: A4 portrait;
    margin-top: 0.8in;
    margin-bottom: 0.8in;
  ...
  @media print {
    ...
    /* Sembunyikan doc-header manual saat diprint karena sudah ditangani oleh @top-right */
    .doc-header {
      display: none;
    }
  }

  /* SUPAYA TABEL TIDA KEPOTONG / NABRAK ATAS SAAT PINDAH HALAMAN */
  table {
    width: 100%;
